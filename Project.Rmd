...
bing_word_counts
```
What's interesting is that there is only 345 unique words being included. In the lexicon, there's around 6000 unique words, but apparently there must either be a lot of words not being included 
...
What's interesting is that rating 5 is very 



```{r}
n1 <- tokens_stemmed %>% filter(reviews.rating == 1)
sentiment_1 <- tokens_stemmed_bing$overall_sentiment
sentiment_1
