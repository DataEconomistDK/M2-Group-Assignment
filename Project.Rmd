...
Now we want to train our model. To do this we will be using glmnet which can handle parallel processing, this make it possible for training the model with cross validation.
...
As the above result shows, the model could predict 93% of the 4 and 5 star rated reviews.
