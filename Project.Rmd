...
We here want to primarily work with tidy text, where there is one token per row. This is now created below and some additional cleaning are done, which is easier to do with the tokens directly. 
